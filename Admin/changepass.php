...
<div id="sc-password">
  ...
  <div class="sc-container">
    <lable>जुना पासओर्ड</lable>
    <input type="password" name="oldpass" placeholder="जुना पासओर्ड टाका"/>
    <lable>नविन पासओर्ड</lable>
    <input type="password" name="newpass" placeholder="नविन पासओर्ड टाका"/>
    <lable>पासओर्ड पुष्टी करा</lable>
    <input type="password" name="pass2" placeholder="पासओर्ड पुष्टी करा"/>
