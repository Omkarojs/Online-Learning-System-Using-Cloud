                    ...
                    <?php
                      ...
                      <li class="nav-item dropdown dropdown-hover dropdown-subitem">
                        ...
                        <?php
                          ...
                          $sql2 ="SELECT * FROM student Where email='$user'" ;
                         ...
                         $query1 = "SELECT * from category Where category='$category' and year='$year' and semister='$semister' ";
                         $result1 = mysqli_query($conn,$query1);
                         
                         while($row1 = mysqli_fetch_array($result1))
                         { 
                            {?> 
                          <a class="dropdown-item ps-3 border-radius-md mb-1" href="substudent.php?id=<?php echo $row1['sub_category']; ?>&mode=edit">
        ...
        cursor: pointer;
            ...
            <form action="" method="post">
                ...
                <li class="nav-item ms-lg-auto">
                  ...
                  echo "<a class='nav-link nav-link-icon me-2' href='sprofile.php?id=" . $_SESSION['username'] . "&Mode=edit' >
                    
                    <p class='d-inline text-sm z-index-1 font-weight-bold' data-bs-toggle='tooltip' data-bs-placement='bottom' title='Profile Edit'>" .$_SESSION['username']. "</p>
                  </a>";
                  ?>
                </li>
                <li class="nav-item my-auto ms-3 ms-lg-0">
                  <a href="index.php" class="btn btn-sm  bg-gradient-primary  btn-round mb-0 me-1 mt-2 mt-md-0">Logout</a>
                </li>
              </ul>
            </div>
          </div>
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-md-12">
          ...
          $sql1="SELECT * FROM student Where email='$user'" ;
        ...
        if(isset($_POST['search'])){
          $search_value=$_POST["search1"];
                  ...
                  while($row = mysqli_fetch_assoc($result)){
                    $sql = "SELECT * FROM video WHERE category='$category' and subject='$search_value' AND year='$year' AND semister='$semister' And status='Active'   ORDER BY id DESC";
		 ...
		 $sql = "SELECT * FROM video WHERE category='$category' AND year='$year' AND semister='$semister' And status='Active'   ORDER BY id DESC";
		 $res = mysqli_query($conn, $sql);
		 ...
		 ?>
          <div class="col-md-4">
              <a href="">
                ...
                <div class="mt-2 ms-2">
                  <?php echo "<b>".$subject."&nbsp;&nbsp;" .$series."</b>";?>
                  <?php echo "<a href='chat.php?id=" . $video['id'] . "&Mode=edit' style='float:right;color:#0074D9;'>For Any Query Click Here</a>";?>
                </div>
              </a>
            </div>
            <?php 
